...
from dvc_objects.db.local import LocalObjectDB
...
def test_status_download_optimization(mocker, dvc):
    ...
    """
    from dvc_objects.status import compare_status
...
def test_staging_file(tmp_dir, dvc):
    from dvc_objects import check, save
    from dvc_objects.stage import get_staging, stage
